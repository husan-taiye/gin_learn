...
func InitWebServer() *gin.Engine {
	...
	articleDAO := article3.NewArticleDAO(db)
...
// 用户服务提供
var userSvcProvider = wire.NewSet(dao.NewUserDao, cache.NewUserCache, repository.NewUserRepository, ioc.InitUserService)
