...
// Source: webook/internal/repository/article/mysql.go
//
// Generated by this command:
//
//	mockgen -source=webook/internal/repository/article/mysql.go -package=artrepomocks -destination=webook/internal/repository/article/mocks/article_mock.go
//
