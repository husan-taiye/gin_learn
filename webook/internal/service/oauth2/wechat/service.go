...
func (o *OAuth2Service) AuthURL(ctx context.Context) (string, error) {
...
func (o *OAuth2Service) VerifyCode(ctx context.Context, code string, state string) (domain.WechatInfo, error) {
