...
// Source: webook/internal/wechat/user.go
//
// Generated by this command:
//
//	mockgen -source=webook/internal/wechat/user.go -package=svcmocks -destination=webook/internal/wechat/mocks/user_mock.go
//
