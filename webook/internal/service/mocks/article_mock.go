...
// Source: webook/internal/service/mysql.go
//
// Generated by this command:
//
//	mockgen -source=webook/internal/service/mysql.go -package=svcmocks -destination=webook/internal/service/mocks/article_mock.go
//
